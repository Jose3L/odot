...
describe "Creating todo lists" do
	...
	it "display an error when the todo list has no tittle" do
	...
	it "display an error when the todo list has a tittle less than 3 characters" do
		expect(TodoList.count).to eq(0)
	...
	it "display an error when the todo list has description less than 5 characters" do
		...
		create_todo_list title: "Grosey list", description: "Food"
